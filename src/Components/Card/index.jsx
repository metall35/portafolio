...
const Card = ({ title, children, isExpirience = false }) => {
    return (
        <div className={`bg-[#190b2e] p-6 rounded-2xl shadow-lg transition duration-300 ease-in-out transform hover:scale-105 h-full ${isExpirience && "col-span-1 md:col-span-2"}`}>
